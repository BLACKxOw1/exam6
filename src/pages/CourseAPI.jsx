...
function CourseAPI() {
  ...
  const cards = [
    ...
    },
    {
      ...
      desc: "View a random single product from Course API",
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {cards.map((item) => (
          <div
            ...
            className="cursor-pointer bg-white dark:bg-zinc-600 rounded-xl shadow-md hover:shadow-lg transition p-6"
          >
